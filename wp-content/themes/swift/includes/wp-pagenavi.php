...
function swift_pagenavi($before = '', $after = '') {
	global $wpdb, $wp_query;
	swift_pagenavi_init(); //Calling the pagenavi_init() function
	if (!is_single()) {
		...
		$larger_start_page_start = (swift_n_round($start_page, 10) + $larger_page_multiple) - $larger_per_page;
		$larger_start_page_end = swift_n_round($start_page, 10) + $larger_page_multiple;
		$larger_end_page_start = swift_n_round($end_page, 10) + $larger_page_multiple;
		$larger_end_page_end = swift_n_round($end_page, 10) + ($larger_per_page);
...
function swift_n_round($num, $tonearest) {
   return floor($num/$tonearest)*$tonearest;
}
function swift_pagenavi_init() {
	//pagenavi_textdomain();
	// Add Options
